...
HD_PWD='D:/CS/ZJU_CO/Lab0/Lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX4to1_lb0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MUX4to1_lb0.tcl -notrace
