...
HD_PWD='D:/CS/ZJU_CO/Lab0/Lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX4to1_lb0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX4to1_lb0.tcl
