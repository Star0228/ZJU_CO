...
HD_PWD='C:/Users/asus/Desktop/Seg7_Dev/Seg7_Dev.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seg7_Dev.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seg7_Dev.tcl
