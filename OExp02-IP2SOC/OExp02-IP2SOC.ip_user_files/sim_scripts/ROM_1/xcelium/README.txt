...
#
# Generated by export_simulation on Sun May 05 11:29:23 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ROM_1.sh' script.
...
./ROM_1.sh -noclean_files

For more information on the script, please type './ROM_1.sh -help'.
