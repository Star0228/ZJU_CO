...
HD_PWD='D:/CS/ZJU_CO/OExp02-IP2SOC/OExp02-IP2SOC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CSSTE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CSSTE.tcl
