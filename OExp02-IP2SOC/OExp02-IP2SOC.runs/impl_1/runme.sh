...
HD_PWD='D:/CS/ZJU_CO/OExp02-IP2SOC/OExp02-IP2SOC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CSSTE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CSSTE.tcl -notrace
